 ...
 */
const pgp = require('pg-promise')(/* options */pgPromiseOptions)



/**
 * step 3 : PREPARE ACCESS TO ./sql files along the complete webservice
 */
...
/**
 * step 4 : PREPARE CONTEXT AND SETTINGS (PASSWORD, HOST, PORT...) FOR PGP
 */
